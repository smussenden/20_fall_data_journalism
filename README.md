# Data Journalism | JOUR472/772 | Fall 2020
...
* **Weekly Session Time: Tuesday 11:30am - 1:50pm**
* **Weekly Session Location: Zoom **
...
* **Office Hours: Schedule Me**

### Objective

This is a practical, hands-on, course in the basics of data journalism. It is a journalism class that teaches students to use software tools, statistical analysis, data programming, computational thinking and other techniques as part of the reporting process. It teaches the transparent application of social science statistical methods to the analysis of structured and unstructured digital information as part of the investigative reporting process, a meticulous, community-based approach to unearthing key facts, patterns and proof in the service of telling stories.  

### Learning Outcomes

After successfully completing this course, we expect you to be able to:

* Use data programming to “interview” data stored in structured and unstructured digital formats. You will learn a systematic approach to finding patterns, promising leads and stories in data and to discover what no one has ever known before, documenting your work in a way that is reproducible and transparent.
...
* **Hardware**: It may seem obvious, but this class requires regular access to a computer, either a desktop or a laptop. Mac (MacOS), PC (Windows), or Linux operating systems are all fine.  It may be technically possible to do this work on a Chromebook (Chrome OS) or an iPad (iOS), but it will prove very challenging and may require you to purchase access to a cloud platform for data analysis.  If you don't have access to a desktop or laptop running MacOS, Windows or Linux, please reach out to me ASAP.  If you are on campus, it is my understanding that students will have access to a limited number of shared spaces in Knight Hall with computers that can be used for classes like this one.    
* **Textbook**: There is no book to buy for this class.  Readings from selected sources will be posted to ELMS or linked to online.
* **Web Accounts**: You will need the following free accounts:
...
* **Software and Programming Languages**: You will need to install the following FREE software and programming languages on your machine.
...
* Data acquisition project - 15%
* Data reporting project I (Reverse engineering an existing story) - 25%
* Data reporting project II (Finding your own story) - 25%
* Weekly in-class coding exercises - 10 %
* Weekly lab submissions - 25%
* Weekly readings, discussion posts - 10%
* Minus and plus grading will be assessed as follows: 98-100 = A+; 93-97 = A; 90-92 = A-; 88-89 = B+; 83-87 = B; 80-82 = B-; 78-79 = C+; 73-77 = C; 70-72 = C-; 68-69 = D+; 63-67 = D; 60-62 = D-; Below 60 = F.

### Class Format

This is an entirely online course. There is a weekly "synchronous" live class meeting that you will be expected to attend on Tuesdays from 11:30 a.m. to 1:50 p.m. on Zoom.  And there is an "asynchronous" weekly lab that you will be expected to complete at a time of your choosing.      

### Attendance Policy

I think it's important for you to attend every single synchronous meeting of the course on Zoom.

But I also know that we're living in in unusual times. You or someone in your family may get sick.  Your internet access may be spotty during class.  You may have unexpected family obligations that prevent you from attending.  Things happen, especially now.  

If you are unable to attend class, please use ELMS to send me a message either before class or shortly after explaining why you were unable to attend. If you are unable to attend because of illness, please fill out a copy of this university form and send it through ELMS [link](https://docs.google.com/document/d/1l-9fET8hekKoXGzEIj8BepEjvpLxAnc_foZUrWLYCmA/edit).         

### Asynchronous Meeting Policies     

We will meet weekly on Zoom. Please keep the following things in mind:

* Please be logged in to our Zoom at or before 11:30 a.m. on Tuesdays. It's important that we start promptly.
* Please keep your microphone muted unless you're speaking.
* Most weeks, you will need to participate in live coding exercises during class, so you should have access to a computer with the necessary software.
* I would ask that you keep your web camera on during class.  It helps me teach to be able to see your face, and I believe it creates a more engaging atmosphere for the whole class.  But, I know some of you may have valid reasons for wanting to keep your web camera off. If you'd like to attend class without your webcam on, please send me a note via ELMS ASAP at the beginning of the semester.
* Please be prepared to engage at all times. There will be polls, questions for you to answer in the chat, requests from me to share your screen, requests from me to answer questions verbally and breakout rooms.  
* During our class, please do not engage in other work or business.
* Just as you would be during an in-person class, please be respectful of me and your colleagues. I literally don't care what you wear, but please wear clothes. Make sure your webcam doesn't show racist, sexist or otherwise offensive material.
* The audio and video of our session will be recorded and posted to ELMS.            
* If Zoom goes down during our meeting, we will have a backup meeting on Webex. You should go to ELMS and await further instruction.

### Assignment deadlines

Unless otherwise specified, all assignments must be turned in before 11:59 p.m. on the day they are due.  Late assignments will be graded under the following rubric:
  * Turned in late, within 24 hours of deadline: -20 percent.
  * Turned in late, between 24 and 48 hours of deadline: -30 percent.
  * Turned in late, between 48 and 72 hours of deadline: -40 percent.   
  * Turned in late, beyond 72 hours of deadline: marked 0.

This is an unusual semester. If your health, your family's health or other life challenges make it impossible for you to meet the assigned deadlines, it is the policy of the university -- and me -- to work "creatively and compassionately" with you to meet the course requirements.  

I am happy to make case-by-case exceptions to the late assignment grading policy as circumstances warrant.  If you will be unable to make a deadline, please reach out to me and explain why. To the extent that you are able, please reach out in advance. If the reason is illness, please fill out a copy of this university form and send it through ELMS [link](https://docs.google.com/document/d/1l-9fET8hekKoXGzEIj8BepEjvpLxAnc_foZUrWLYCmA/edit).  
