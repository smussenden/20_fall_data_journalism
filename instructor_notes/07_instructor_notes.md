1. Review forum post
* Joined a dataset they built of nuisance abatement suits. to...
* https://www.propublica.org/datastore/dataset/new-york-state-supreme-court-nuisance-abatement-actions
* Census data.  
* That allowed them to determine that the vast majority of these cases happened in places with large minority population.
2. Upcoming Project due this weekend.
  * If you haven't loaded your data, or confused about what to do, set up a time to meet with me.
  * Everyone knows: these are questions I want you to review. SHOW LINK.
  * I have heard from some of you that some of you were maybe splitting it up where some of you were doing coding, others were writing up memo, others were planning to present. And I want to say, I want each of you involved at every step.  I want ALL of you involved in writing the code. If that means splitting it up, where you each take a question, that's fine.
  * Kara asked how to work.  I'd suggest each of you work in a document in your own repo. One of you keep the canonical version you'll submit.    
  * THE MORE YOU HAVE DONE, THE BETTER!

3.  Review lab.  Go over answer to question. Go over joins -- left, right, inner.  Also introduce them to outer joins, and anti joins. 

4.  There is no in-class assignment this week. Instead, use the time to meet as a group.  I want to see what kind of progress you're making.

2. Review inner, outer and right joins.
