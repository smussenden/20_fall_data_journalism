...
We'll use two functions here to make a chart, both from the ggplot2 library. 

* ggplot() - initialize a chart
* geom_bar() - display the data as a bar
...
#### Round the labels to make them prettier  
...
maryland %>%
  ...
  geom_text(aes(label=round(case_rate,2)))

#### Adjust the labels a little bit
...
maryland %>%
  ...
  geom_text(aes(label=round(case_rate,2)), vjust=-.5)
