...
* pluses vs pipes
* ggplot function, says initiate a chart.  aes says waht to put on x and y axies.
* geom_bar says make a bar chart. 
* stat=idenity is confusing, but what it means is pull the value out of the column in the y axis.  
